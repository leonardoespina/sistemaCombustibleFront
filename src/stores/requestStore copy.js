...
export const useRequestStore = defineStore("requests", () => {
  ...
  // Listas auxiliares para formulario de solicitudes
  const subdependenciasAutorizadas = ref([]);
  const llenaderosPorCombustible = ref([]);
  const loadingAuxiliar = ref(false);
  ...
  /**
   * Obtener llenaderos por tipo de combustible
   */
  async function fetchLlenaderosPorCombustible(idTipoCombustible) {
    ...
    try {
      ...
      console.error("Error al obtener llenaderos:", error);
  ...
  return {
    ...
    pagination,
    // Listas auxiliares
    subdependenciasAutorizadas,
    llenaderosPorCombustible,
    loadingAuxiliar,
    // Actions
    fetchRequests,
    createRequest,
