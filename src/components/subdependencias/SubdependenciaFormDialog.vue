            ...
            <div v-if="dependenciaSeleccionada.tipo_venta === 'VENTA'">
              <q-input
                ...
                :rules="[
                  (val) =>
                    !!val ||
                    'La ubicación es obligatoria para tipo de venta VENTA',
                  (val) =>
                    val.trim().length > 0 ||
              ...
              <q-input
                ...
                :rules="[
                  (val) =>
                    !!val ||
                    'El responsable es obligatorio para tipo de venta VENTA',
                  (val) =>
                    val.trim().length > 0 ||
              ...
              <q-input
                ...
                :rules="[
                  (val) =>
                    !!val ||
                    'La cédula/RIF es obligatoria para tipo de venta VENTA',
                  (val) =>
                    val.trim().length > 0 ||
                    'La cédula/RIF no puede estar vacía',
                ]"
              />
              ...
              <div v-if="formData.cobra_venta" class="q-mt-md">
                ...
                <q-input
                  ...
                  :rules="[
                    (val) =>
                      !!val ||
                      'La ubicación es obligatoria cuando se cobra venta',
                    (val) =>
                      val.trim().length > 0 ||
                      'La ubicación no puede estar vacía',
                  ]"
                ...
                <q-input
                  ...
                  :rules="[
                    (val) =>
                      !!val ||
                      'El responsable es obligatorio cuando se cobra venta',
                    (val) =>
                      val.trim().length > 0 ||
                      'El responsable no puede estar vacío',
                  ]"
                ...
                <q-input
                  ...
                  :rules="[
                    (val) =>
                      !!val ||
                      'La cédula/RIF es obligatoria cuando se cobra venta',
                    (val) =>
                      val.trim().length > 0 ||
                      'La cédula/RIF no puede estar vacía',
                  ]"
