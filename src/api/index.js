...
// Si está vacío (caso proxy), usamos string vacío para que Axios use la URL relativa del navegador
  ...
  (error) => {
    ...
    if (!isSilenciado) {
      Notify.create({
        ...
        message: message,
        position: "top",
        timeout: is409DeReversion ? 6000 : 3000,
        actions: is409DeReversion ? [{ label: "OK", color: "white" }] : undefined,
      });
    }
